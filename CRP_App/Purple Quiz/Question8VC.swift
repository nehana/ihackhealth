...
public var x8: Double = 0

class Question8VC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        nameLabel.text = "Was this an emergency operation?"
        //Add "not elective" here!
        ...
        yesButton.addTarget(self, action: #selector(toResultsPage), for: .touchUpInside)
        ...
        noButton.addTarget(self, action: #selector(toResultsPage), for: .touchUpInside)
