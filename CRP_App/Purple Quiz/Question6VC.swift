...
public var x6: Double = 0

class Question6VC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        nameLabel.text = "Is the post-operative length of stay above 1 day?"
...
//        nameLabel.translatesAutoresizingMaskIntoConstraints = false
        ...
        yesButton.addTarget(self, action: #selector(toQuestion7), for: .touchUpInside)
        ...
        noButton.addTarget(self, action: #selector(toQuestion7), for: .touchUpInside)
        view.addSubview(noButton)
        
    }
    
    @objc func toQuestion7() {
        
        self.performSegue(withIdentifier: "toQ7", sender: self)
