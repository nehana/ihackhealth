...
//  CRP_App
//
//  Created by Neha Nagabothu on 3/4/20.
...
class InfoViewController: UIViewController {
    ...
    submitButton.setTitle("Visit", for: .normal)
    ...
    submitButton.addTarget(self, action: #selector(toLink), for: .touchUpInside)
    ...
    @objc func toLink() {
        ...
        let url = URL (string: "https://www.heart.org/en/health-topics/venous-thromboembolism/what-is-venous-thromboembolism-vte")!
