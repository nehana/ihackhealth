...
class Question5VC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        nameLabel.text = "Did you have a panniculectomy?"
        ...
        yesButton.addTarget(self, action: #selector(toQuestion6), for: .touchUpInside)
        ...
        noButton.addTarget(self, action: #selector(toQuestion6), for: .touchUpInside)
        view.addSubview(noButton)
        
    }
    
    @objc func toQuestion6() {
        
        self.performSegue(withIdentifier: "toQ6", sender: self)
